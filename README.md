...
- **Map start extent (phone, max-width 768px):** Eastern Mediterranean overview — Greece–Levant / Black Sea–Egypt. Leaflet `setView` at **36.0°N, 28.6°E**, zoom **5**. On a 390×844 phone that visible box is about **SW 29.2°N, 20.0°E → NE 42.8°N, 37.2°E**. Reset view uses the same center/zoom. Sparse overview labels: Jerusalem, Antioch, Ephesus, Corinth, Alexandria, Damascus, plus ASIA and GALATIA.
