...
- **Map start extent (phone, max-width 768px):** Eastern Mediterranean overview — Greece–Levant / Black Sea–Egypt. Leaflet `fitBounds` of **SW 29.2°N, 20.0°E → NE 42.8°N, 37.2°E** (about center **36.0°N, 28.6°E**, zoom **5**, maxZoom 5.5). Reset view uses the same box. Sparse overview labels: Jerusalem, Antioch, Ephesus, Corinth, Alexandria, Damascus, plus ASIA and GALATIA.
